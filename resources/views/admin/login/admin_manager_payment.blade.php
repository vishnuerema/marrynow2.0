         ...
         <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
              ...
              <div class="std_pynt_txt">
                  Standard payment Rate
    					...
    					<div class="form-group sp_paymt">
    				  		<input type="text" class="form-control manager_subit_pay shop_pmt">
    					</div>
    					<div class="submit_btn_pay_sp">
    				  		<input type="button" value="Submit" onclick="manager_admin_paymt()" class="btn_shop_pmt">
    					</div>
               ...
               <div class="list_shop_pay_claim" id="total_shop_paid{{$data->user_id}}">
                   ...
                   <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4">
                     ...
                     <div class="list_val_pay_clm_val matri_mngr_txt">
                       {{$data->user_matri_id}}
                     </div>
                   </div>
                   <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4">
                   ...
                   <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                       <div class="text-center">
                        <input type="button" value="paid" onclick="manager_amn_paid(this.id)" id="{{$data->user_id}}" class="btn_shop_pmt">
                        </div>
                    </div>
               </div>
               @endforeach
           ...
           <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
             <div class="adjs_pay_wids">
                ...
                <div class="form-group sp_paymt">
                    <input type="text" class="form-control manager_subit_pay_day shop_pmt">
                </div>
                <div class="submit_btn_pay_sp">
                    <input type="button" value="Submit" onclick="manger_admn_pymt_day()" class="btn_shop_pmt">
                </div>
            </div>
          </div>
          <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
              <div class="adjs_pay_wids">
                ...
                <div class="form-group sp_paymt">
                    <input type="text" class="form-control manager_subit_pay_wek shop_pmt">
                </div>
                <div class="submit_btn_pay_sp">
                    <input type="button" value="Submit" onclick="manger_admn_pymt_wek()" class="btn_shop_pmt">
                </div>
            </div>
          </div>
          <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
              <div class="adjs_pay_wids">
                ...
                <div class="form-group sp_paymt">
                    <input type="text" class="form-control manager_subit_pay_mnth shop_pmt">
                </div>
                <div class="submit_btn_pay_sp">
                    <input type="button" value="Submit" onclick="manger_admn_pymt_mnth()" class="btn_shop_pmt">
                </div>
            </div>
          </div>
		    </div>
