...
<body class="login_backclr">
	<section class="login_marrynow">
		<div class="login_commn">
			<form class="login_form">
				<div class="form-group login_user">
				    <label class="login_labl"for="exampleInputEmail1">User name</label>
				...
				<div class="form-group login_pass">
					<label class="login_labl" for="exampleInputPassword1">Password</label>
